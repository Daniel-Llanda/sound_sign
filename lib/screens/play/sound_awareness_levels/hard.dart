...
// ================= SCREEN =================
class SoundAwarenessHard extends StatefulWidget {
  const SoundAwarenessHard({super.key});

  @override
  State<SoundAwarenessHard> createState() => _SoundAwarenessHardState();
}

class _SoundAwarenessHardState extends State<SoundAwarenessHard> {
  ...
  void _generateQuiz() {
    ...
    // Allow repeating sounds for 15 questions
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Sound Awareness – Hard"),
        centerTitle: true,
